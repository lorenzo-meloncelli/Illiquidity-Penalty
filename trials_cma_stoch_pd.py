...
Asset classes:
  ...
  GLOB_PD        — Global Private Debt (hedged USD)
...
mu = np.array([0.0324, 0.0459, 0.0709, 0.0518, 0.0805, 0.0980])

# Annual volatilities
sigma = np.array([0.0182, 0.0439, 0.1701, 0.0728, 0.1102, 0.2000])

# Raw illiquidity scores (1 = most liquid, 4 = most illiquid)
scores_raw = np.array([1.00, 1.45, 1.50, 2.50, 3.7, 5.00])
...
# Correlation matrix
corr = np.array([
    [ 1.000000,  0.140529, -0.009157, -0.011059,  0.010276, -0.011961],
    [ 0.140529,  1.000000, -0.012748, -0.034921, -0.124714, -0.063755],
    [-0.009157, -0.012748,  1.000000,  0.859623,  0.660099,  0.873998],
    [-0.011059, -0.034921,  0.859623,  1.000000,  0.732100,  0.869733],
    [ 0.010276, -0.124714,  0.660099,  0.732100,  1.000000,  0.723073],
    [-0.011961, -0.063755,  0.873998,  0.869733,  0.723073,  1.000000],
])
